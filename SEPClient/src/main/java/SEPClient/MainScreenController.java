...
public class MainScreenController {
    ...
    public void refreshView()
    {
    	...
    	if(user instanceof Seller)
    	{
    		...
    		MainScreen_ButtonMyProducts.setDisable(true); //eig false, aber in der 1. Iteration noch nicht ben�tigt
    	...
    	else
    	{
    		...
    		MainScreen_ButtonPurchases.setDisable(true); //eig false, aber in der 1. Iteration noch nicht ben�tigt
    	}
